<?php
// source: C:\Program Files (x86)\EasyPHP-DevServer-13.1VC11\data\localweb\projects\vcelyweb\app/config/config.neon 
// source: C:\Program Files (x86)\EasyPHP-DevServer-13.1VC11\data\localweb\projects\vcelyweb\app/config/config.local.neon 
...
class SystemContainer extends Nette\DI\Container
{
	...
	protected $meta = array(
		'types' => array(
			'nette\\object' => array(
				...
				'22_App_Model_CiselnikTypTransakcieRepository',
				'23_App_Model_CiselnikTypUlaRepository',
				'24_App_Model_PrijmyVydajeRepository',
				'25_App_Model_UlRepository',
				'26_App_Model_UserManager',
				'27_App_Model_VcelnicaRepository',
				'container',
			),
			...
			'app\\model\\ciselniktyptransakcierepository' => array(
				'22_App_Model_CiselnikTypTransakcieRepository',
			),
			'app\\model\\ciselniktypularepository' => array('23_App_Model_CiselnikTypUlaRepository'),
			'app\\model\\prijmyvydajerepository' => array('24_App_Model_PrijmyVydajeRepository'),
			'app\\model\\ulrepository' => array('25_App_Model_UlRepository'),
			'nette\\security\\iauthenticator' => array('26_App_Model_UserManager'),
			'app\\model\\usermanager' => array('26_App_Model_UserManager'),
			'app\\model\\vcelnicarepository' => array('27_App_Model_VcelnicaRepository'),
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => 'C:\\Program Files (x86)\\EasyPHP-DevServer-13.1VC11\\data\\localweb\\projects\\vcelyweb\\app',
			'wwwDir' => 'C:\\Program Files (x86)\\EasyPHP-DevServer-13.1VC11\\data\\localweb\\projects\\vcelyweb\\www',
			'debugMode' => TRUE,
			...
			'tempDir' => 'C:\\Program Files (x86)\\EasyPHP-DevServer-13.1VC11\\data\\localweb\\projects\\vcelyweb\\app/../temp',
		));
	}


	/**
	 * @return App\Model\CiselnikTypTransakcieRepository
	 */
	public function createService__22_App_Model_CiselnikTypTransakcieRepository()
	{
		$service = new App\Model\CiselnikTypTransakcieRepository($this->getService('database.default.context'));
		return $service;
	}


	/**
	 * @return App\Model\CiselnikTypUlaRepository
	 */
	public function createService__23_App_Model_CiselnikTypUlaRepository()
	{
		$service = new App\Model\CiselnikTypUlaRepository($this->getService('database.default.context'));
		return $service;
	}


	/**
	 * @return App\Model\PrijmyVydajeRepository
	 */
	public function createService__24_App_Model_PrijmyVydajeRepository()
	{
		$service = new App\Model\PrijmyVydajeRepository($this->getService('database.default.context'));
		return $service;
	}


	/**
	 * @return App\Model\UlRepository
	 */
	public function createService__25_App_Model_UlRepository()
	{
		$service = new App\Model\UlRepository($this->getService('database.default.context'));
		return $service;
	}
	...
	/**
	 * @return App\Model\VcelnicaRepository
	 */
	public function createService__27_App_Model_VcelnicaRepository()
	{
		$service = new App\Model\VcelnicaRepository($this->getService('database.default.context'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\\Program Files (x86)\\EasyPHP-DevServer-13.1VC11\\data\\localweb\\projects\\vcelyweb\\app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=old.slspo.sk;dbname=vcelyweb', 'cujan', 'cujan', array('lazy' => TRUE));
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('C:\\Program Files (x86)\\EasyPHP-DevServer-13.1VC11\\data\\localweb\\projects\\vcelyweb\\app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Application\PresenterFactory('C:\\Program Files (x86)\\EasyPHP-DevServer-13.1VC11\\data\\localweb\\projects\\vcelyweb\\app', $this);
	...
	{
		$service = new Nette\Caching\Storages\PhpFileStorage('C:\\Program Files (x86)\\EasyPHP-DevServer-13.1VC11\\data\\localweb\\projects\\vcelyweb\\app/../temp/cache', $this->getService('nette.cacheJournal'));
	...
	{
		$service = new Nette\Security\User($this->getService('nette.userStorage'), $this->getService('26_App_Model_UserManager'));
