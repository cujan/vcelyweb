...
list($_b, $_g, $_l) = $template->initialize('4326138185', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block content
//
if (!function_exists($_b->blocks['content'][] = '_lb1bcc7e6c57_content')) { function _lb1bcc7e6c57_content($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><div id="banner">
...
// block title
//
if (!function_exists($_b->blocks['title'][] = '_lbd1df8f2ff7_title')) { function _lbd1df8f2ff7_title($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb7ac5e85469_scripts')) { function _lb7ac5e85469_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
...
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lbfd20d35cfb_head')) { function _lbfd20d35cfb_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
?><style>
